...
class SiteController extends Controller {
    ...
    public function actionIndex() {
        ...
        Yii::app()->clientScript->registerMetaTag(" bone, joint, cancer, colds, flu, diabetes, gastrointestinal health, heart health, mental health, men's health, women's health,antiinflammatory foods, anti-inflammatory, dr weils, healthyaging, vegetarian diet, healthy aging book, high fiber diet,", 'keywords');
